    ...
    return (
        <section className='bg-veryLightBlue'>
            <Container className="text-center py-20">
                <div className='border-[1.5px] border-[#aea9c5] rounded-2xl py-10 px-5 flex flex-col items-center justify-center gap-10'>
                    <h1 className='text-3xl text-darkBlue md:text-5xl'>Let's Bring Your Vision to Life</h1>
