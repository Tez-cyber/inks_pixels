    ...
    const gridDetails = [
        {
            ...
            text: `We deliver visually captivating and strategically crafted
                    products that help our clients stand out.
                `
        },
        {
            icon: <AdjustIcon
            ...
            text: `Our vision is to be the leading creative partner in Nigeria, 
                    driving our clients' success through exceptional design.
                `
        },
        {
            icon: <HandshakeIcon
            ...
            text: `We work closely with businesses and individuals to
                    establish a strong, memorable presence in their respective
                    markets.
                `
        },
    ]
                ...
                <div className="grid gap-12 items-center md:grid-cols-2">
                    ...
                    <div>
                        ...
                        <p className="text-gray-700 mb-6 leading-relaxed">
                            Ink and Pixels Nigeria Limited is a dynamic and innovative
                            creative agency specializing in comprehensive branding, design,
                            packaging, and printing solutions.
                        </p>
